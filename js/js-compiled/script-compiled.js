...
$(document).ready(function () {
  ...
  $("#accordion > .lpFAQs__wrapper > .lpFAQs__paragraph").hide(), $("#accordion > .lpFAQs__wrapper").click(function (e) {
    if (!$(e.target).closest(".lpFAQs__headline").length) return;
    return $(this).hasClass("active") ? $(this).removeClass("active").find(".lpFAQs__paragraph").slideUp() : ($("#accordion > .lpFAQs__wrapper > .lpFAQs__paragraph").slideUp(), $("#accordion > .lpFAQs__wrapper.active").removeClass("active"), $(this).addClass("active").find(".lpFAQs__paragraph").slideDown()), !1;
  }), // smooth scroller
...
-1 < window.location.href.indexOf("alza") ? $(window).load(function () {
